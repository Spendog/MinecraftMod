...
import com.example.educationmod.config.GuiConfigScreen;
...
public class ClientProxy extends CommonProxy {
    ...
    private static final KeyBinding OPEN_GUI_KEY =
            new KeyBinding("Open Config GUI", Keyboard.KEY_G, "key.categories.misc");
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (OPEN_GUI_KEY.isPressed()) {
            ...
            // Open the custom config screen when the key is pressed
            minecraft.displayGuiScreen(new GuiConfigScreen(currentScreen));
        }
    }
}
